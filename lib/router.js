...
router.get('/sexinsex/:id/:routeParams?', lazyloadRouteHandler('./routes/sexinsex/index'));
// 色中色001
router.get('/sexinsex001/:fid/:type?', lazyloadRouteHandler('./routes/sexinsex001/index'));

router.get('/2048hjd/:fid/:type?', lazyloadRouteHandler('./routes-me/2048hjd/index'));
