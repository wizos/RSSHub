...
router.get('/t66y/:id/:routeParams?', require('./routes/t66y/index'));
...
// NGA
router.get('/nga/forum/:fid/:routeParams?', require('./routes/nga/forum'));
...
// 2048
router.get('/2048/bbs/:fid/:type?', require('./routes/2048/bbs'));
...
// 91forum
router.get('/91/forum/best', require('./routes/91/forum-best'));
router.get('/91/forum/:fid/:order?', require('./routes/91/forum'));

router.get('/91trg/forum/:fid', require('./routes/91trg/forum'));

router.get('/ypllt/forum/:fid/:tid?', require('./routes/ypllt/forum'));

router.get('/tiboo/:fid', require('./routes/tiboo/tiboo'));

router.get('/1024hgc/:fid/:routeParams?', require('./routes/1024hgc/index'));

// 色中色001
router.get('/sis001/:fid/:type?', require('./routes/sexinsex001/index'));

router.get('/yamiboard/:fid', require('./routes/yamiboard/forum'));
router.get('/yamigama/:fid', require('./routes/yamigama/forum'));

// Cool 18
// router.get('/cool18/best', require('./routes/cool18/best'));

// 爱生活
// router.get('/aishenghuo/:fid', require('./routes/aishenghuo/index'));
// router.get('/aibj/i', require('./routes/aibj/i'));
router.get('/aibj/:fid', require('./routes/aibj/aibj'));

// App.So 限期优惠软件
router.get('/appso/xianmian', require('./routes/appso/xianmian'));

// 知乎用户的原创内容
router.get('/zhihu/people/express/:id', require('./routes/zhihu/express'));

router.get('/egouz/top', require('./routes/egouz/top'));

router.get('/spaceflightfans/launch-schedule', require('./routes/spaceflightfans/launch-schedule'));
