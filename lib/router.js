...
router.get('/sexinsex/:id/:routeParams?', lazyloadRouteHandler('./routes-my/sexinsex/index'));
// 色中色001
router.get('/sexinsex001/:fid/:type?', lazyloadRouteHandler('./routes-my/sexinsex001/index'));
